...
public class ShowHUD : MonoBehaviour
{
    ...
    void Update()
    {
        hud = Camera.main.GetComponent<HUDActivation>();

        if (hud.objTriggered != null)
        {
            ...
            Rect visualRect = RendererBoundsInScreenSpace(hud.objTriggered.GetComponentInChildren<Renderer>());
